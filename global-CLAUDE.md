...
- When work is finished and about to go up for review, follow the `ship-gate` skill: open the PR first to start the external reviewer, then run a parallel reviewer swarm over the diff, reconcile both streams, and fix at the root.
