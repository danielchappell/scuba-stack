...
- `model` pins the worker's tier (Opus for judgment, Sonnet for execution — see [ARCHITECTURE.md](ARCHITECTURE.md#the-model-split)). The chief of staff and managers are intentionally unpinned.
