...
Thread authority: you may reply to and resolve the external/PR review threads for findings on your own work that you actually fixed, citing the commit. Resolve only what's within your mandate; anything broader goes back to your manager.
